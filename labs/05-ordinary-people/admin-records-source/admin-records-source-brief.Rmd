...
The family is large, and this is the largest section of the book. It holds certified election returns and the rosters of who actually held each seat. It holds voter registration files, every roll-call vote since 1789, campaign-finance filings and lobbying registrations. It holds records of attention, like a year of Wikipedia pageviews. And it holds records of ordinary people: the first names written on Social Security cards, traffic stops, jury strikes, and the mortgage-risk grades a federal agency stamped on neighbourhoods in the 1930s.^[The Home Owners' Loan Corporation's maps, digitised by the University of Richmond's *Mapping Inequality* project: <https://dsl.richmond.edu/panorama/redlining/>.]
