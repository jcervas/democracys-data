# part-2-surveys-code.R -- chunk bodies for part-2-surveys-brief.Rmd
#
...
NDOC  <- RU("Docs in this section")
EXPT  <- RU("Docs elsewhere that read this section's files")
IMPT  <- RU("Docs here that read another section's files")
