...
## Weighting, and the bridge back to Section I
...
## Nonresponse, the trap of this section
...
The order is a teaching order. First what a survey is and what it alone can establish. Then the machinery — weighting, the bridge back to the census — because you should see how the instrument works before trusting anything it produces. Then the two applications in turn: the polls that an election eventually grades, and the opinion studies that nothing ever grades. In full, in reading order:
