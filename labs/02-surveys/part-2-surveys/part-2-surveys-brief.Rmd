...
That contrast is the real bridge between Section I and this one: an enumeration tries to reach everyone and produce a count; a survey reaches a sample and produces an estimate. Everything else in this section — the weights, the margins, the mistakes — follows from choosing the second instrument instead of the first.
