...
# the surname series read off one tick at a time, for the log-scale walk
S10W   <- zg("surnames", 10, "who");   S10N   <- zg("surnames", 10, "observed")
S1000W <- zg("surnames", 1000, "who"); S1000N <- zg("surnames", 1000, "observed")
