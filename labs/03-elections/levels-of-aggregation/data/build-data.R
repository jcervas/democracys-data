...
cty  <- rd("06-putting-data-together/data-sources/data/derived/pres2024_counties.csv")
cen  <- rd("06-putting-data-together/data-sources/data/derived/census_counties.csv")
cd   <- rd("06-putting-data-together/redistricting/data/derived/pres_by_cd_2024.csv")
sta  <- rd("06-putting-data-together/data-sources/data/derived/pres2024_states.csv")
